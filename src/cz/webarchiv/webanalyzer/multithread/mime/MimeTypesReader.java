...
//    private Log logger = null;
    ...
    private static final Logger log4j = Logger.getLogger(MimeTypesReader.class);
...
//    }
    ...
    MimeType[] read(String filepath) {
        try {
            ...
            log4j.fatal("File not found filepath=" + filepath, ex.getCause());
//            Logger.getLogger(MimeTypesReader.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }
    }
    ...
    MimeType[] read(InputStream stream) {
        ...
        try {
            ...
            log4j.fatal("Fatal error while loading mime-types", e.getCause());
    ...
    private MimeType readMimeType(Element element) {
        ...
        try {
            ...
            log4j.info("Mime Type not valid...just ignore it", mte.getCause());
            return null;
        }
